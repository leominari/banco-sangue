...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        if (tfDocumentoDoador.getText() == null
                || tfDocumentoDoador.getText().trim().equals("")
                || !validaCPF.isCPF(tfDocumentoDoador.getText())) {
            JOptionPane.showMessageDialog(null, "Preecha um CPF valido!");
        } else {
            try {
                if (doador.getDados(tfDocumentoDoador.getText())) {
//              tela de doar
                } else {
