...
public class TelaPerguntas extends javax.swing.JFrame {
    ...
    private void taSelecionado(JRadioButton sim, JRadioButton nao, int pergunta) {
    ...
    private boolean yesorNot(JRadioButton sim, JRadioButton nao, int pergunta) {
        taSelecionado(sim, nao, pergunta);
        if (espera) {
            return !nao.isSelected();
        }
        return true;
    }
    ...
    private void btnTriagemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTriagemActionPerformed
        ...
        if (espera) {
            if (triagem.liberacao()) {
                ...
                JOptionPane.showMessageDialog(null, "Infelizmente você não pode realizar a doação!");
                dispose();
                TelaInicial ti = new TelaInicial();
                ti.setVisible(true);
            }
